...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  8 15:26:29 2020
...
# Run the following line of code for the first time
# nltk.download('stopwords')

############################################ GET AND VISUALISE THE DATASET ################################################################

# Reading the dataset
df = pd.read_csv("spam_ham_data_set.csv", encoding = "latin")
df.head()
